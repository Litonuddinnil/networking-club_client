        ...
        <div className="space-y-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-[#03070E] border border-white/10 rounded-2xl text-xs text-white placeholder:text-slate-500 focus:outline-none focus:border-orange-500/40 font-mono transition-colors"
            />
          </div>
            ...
            filteredPosts.map((post: PostItem, idx: number) => {
              ...
              return (
                <article
                  ...
                  className="group relative bg-[#03070E] border border-white/10 hover:border-orange-500/30 p-5 rounded-2xl space-y-3.5 transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/5 cursor-pointer"
                >
                  {/* Category & Time Meta */}
                  <div className="flex flex-wrap items-center justify-between gap-2 text-xs font-mono text-slate-400">
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 font-medium text-[11px]">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 items-start">
                    ...
                    <div className="flex-1 space-y-1.5 min-w-0">
                      <h2 className="font-bold text-base sm:text-lg text-white group-hover:text-orange-300 transition-colors leading-snug">
                        {post.title}
                      </h2>
                  ...
                  <div className="pt-2 border-t border-white/5 flex items-center justify-between text-xs font-mono">
                    ...
                    <span className="inline-flex items-center gap-1 text-orange-400 font-bold group-hover:translate-x-0.5 transition-transform">
                      Read Article
        ...
        >
          ...
          >
            ...
            <div className="p-5 border-b border-white/10 flex items-center justify-between gap-4">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 text-xs font-mono font-medium">
